...
func (mu *MessageUpdate) SetUserID(i int32) *MessageUpdate {
...
func (mu *MessageUpdate) AddUserID(i int32) *MessageUpdate {
	mu.mutation.AddUserID(i)
	return mu
}

// SetRoomID sets the "room_id" field.
func (mu *MessageUpdate) SetRoomID(i int32) *MessageUpdate {
	mu.mutation.ResetRoomID()
	mu.mutation.SetRoomID(i)
	return mu
}

// AddRoomID adds i to the "room_id" field.
func (mu *MessageUpdate) AddRoomID(i int32) *MessageUpdate {
	mu.mutation.AddRoomID(i)
	return mu
}
...
func (mu *MessageUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := mu.mutation.AddedRoomID(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt32,
			Value:  value,
			Column: message.FieldRoomID,
...
// SetUserID sets the "user_id" field.
func (muo *MessageUpdateOne) SetUserID(i int32) *MessageUpdateOne {
...
// AddUserID adds i to the "user_id" field.
func (muo *MessageUpdateOne) AddUserID(i int32) *MessageUpdateOne {
	muo.mutation.AddUserID(i)
	return muo
}

// SetRoomID sets the "room_id" field.
func (muo *MessageUpdateOne) SetRoomID(i int32) *MessageUpdateOne {
	muo.mutation.ResetRoomID()
	muo.mutation.SetRoomID(i)
	return muo
}

// AddRoomID adds i to the "room_id" field.
func (muo *MessageUpdateOne) AddRoomID(i int32) *MessageUpdateOne {
	muo.mutation.AddRoomID(i)
	return muo
}
...
func (muo *MessageUpdateOne) sqlSave(ctx context.Context) (_node *Message, err error) {
	...
	if value, ok := muo.mutation.AddedRoomID(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt32,
			Value:  value,
			Column: message.FieldRoomID,
