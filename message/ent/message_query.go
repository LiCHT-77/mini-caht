...
func (mq *MessageQuery) FirstID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (mq *MessageQuery) FirstIDX(ctx context.Context) int32 {
...
func (mq *MessageQuery) OnlyID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (mq *MessageQuery) OnlyIDX(ctx context.Context) int32 {
...
func (mq *MessageQuery) IDs(ctx context.Context) ([]int32, error) {
	var ids []int32
...
func (mq *MessageQuery) IDsX(ctx context.Context) []int32 {
	ids, err := mq.IDs(ctx)
	if err != nil {
		panic(err)
	}
