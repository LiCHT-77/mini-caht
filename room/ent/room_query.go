...
func (rq *RoomQuery) FirstID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (rq *RoomQuery) FirstIDX(ctx context.Context) int32 {
...
func (rq *RoomQuery) OnlyID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (rq *RoomQuery) OnlyIDX(ctx context.Context) int32 {
...
func (rq *RoomQuery) IDs(ctx context.Context) ([]int32, error) {
	var ids []int32
...
func (rq *RoomQuery) IDsX(ctx context.Context) []int32 {
	ids, err := rq.IDs(ctx)
	if err != nil {
		panic(err)
	}
