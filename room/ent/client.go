...
import (
	...
	"github.com/LiCHT-77/mini-chat/room/ent/migrate"
...
func (c *RoomClient) UpdateOneID(id int32) *RoomUpdateOne {
...
func (c *RoomClient) DeleteOneID(id int32) *RoomDeleteOne {
...
func (c *RoomClient) Get(ctx context.Context, id int32) (*Room, error) {
	return c.Query().Where(room.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *RoomClient) GetX(ctx context.Context, id int32) *Room {
